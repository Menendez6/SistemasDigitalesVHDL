...
-- Equation(s):
-- \inst2|LessThan1~1_combout\ = (\b~combout\(1) & (((!\a~combout\(0) & \b~combout\(0))) # (!\a~combout\(1)))) # (!\b~combout\(1) & (!\a~combout\(0) & (\b~combout\(0) & !\a~combout\(1))))
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = (\a~combout\(2) & (\b~combout\(2) & (\b~combout\(3) $ (!\a~combout\(3))))) # (!\a~combout\(2) & (!\b~combout\(2) & (\b~combout\(3) $ (!\a~combout\(3)))))
...
-- Equation(s):
-- \inst2|LessThan1~0_combout\ = (\b~combout\(3) & (((!\a~combout\(2) & \b~combout\(2))) # (!\a~combout\(3)))) # (!\b~combout\(3) & (!\a~combout\(2) & (!\a~combout\(3) & \b~combout\(2))))
...
-- Equation(s):
-- \inst2|LessThan1~2_combout\ = (\inst2|LessThan1~0_combout\) # ((\inst2|LessThan1~1_combout\ & \inst2|Equal0~0_combout\))
...
-- Equation(s):
-- \inst2|Equal0~1_combout\ = (\b~combout\(1) & (\a~combout\(1) & (\a~combout\(0) $ (!\b~combout\(0))))) # (!\b~combout\(1) & (!\a~combout\(1) & (\a~combout\(0) $ (!\b~combout\(0)))))
...
-- Equation(s):
-- \inst2|LessThan0~1_combout\ = (\b~combout\(1) & (\a~combout\(0) & (!\b~combout\(0) & \a~combout\(1)))) # (!\b~combout\(1) & ((\a~combout\(1)) # ((\a~combout\(0) & !\b~combout\(0)))))
...
-- Equation(s):
-- \inst2|LessThan0~0_combout\ = (\b~combout\(3) & (\a~combout\(2) & (\a~combout\(3) & !\b~combout\(2)))) # (!\b~combout\(3) & ((\a~combout\(3)) # ((\a~combout\(2) & !\b~combout\(2)))))
...
-- Equation(s):
-- \inst2|LessThan0~2_combout\ = (\inst2|LessThan0~0_combout\) # ((\inst2|LessThan0~1_combout\ & \inst2|Equal0~0_combout\))
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\a~combout\(3) & (\a~combout\(0) & (\a~combout\(1) $ (\a~combout\(2))))) # (!\a~combout\(3) & (!\a~combout\(1) & (\a~combout\(0) $ (\a~combout\(2)))))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\a~combout\(1) & ((\a~combout\(0) & (\a~combout\(3))) # (!\a~combout\(0) & ((\a~combout\(2)))))) # (!\a~combout\(1) & (\a~combout\(2) & (\a~combout\(0) $ (\a~combout\(3)))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\a~combout\(3) & (\a~combout\(2) & ((\a~combout\(1)) # (!\a~combout\(0))))) # (!\a~combout\(3) & (\a~combout\(1) & (!\a~combout\(0) & !\a~combout\(2))))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\a~combout\(0) & (\a~combout\(1) $ (((!\a~combout\(2)))))) # (!\a~combout\(0) & ((\a~combout\(1) & (\a~combout\(3) & !\a~combout\(2))) # (!\a~combout\(1) & (!\a~combout\(3) & \a~combout\(2)))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\a~combout\(1) & (\a~combout\(0) & (!\a~combout\(3)))) # (!\a~combout\(1) & ((\a~combout\(2) & ((!\a~combout\(3)))) # (!\a~combout\(2) & (\a~combout\(0)))))
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (\a~combout\(1) & (!\a~combout\(3) & ((\a~combout\(0)) # (!\a~combout\(2))))) # (!\a~combout\(1) & (\a~combout\(0) & (\a~combout\(3) $ (!\a~combout\(2)))))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\a~combout\(0) & ((\a~combout\(3)) # (\a~combout\(1) $ (\a~combout\(2))))) # (!\a~combout\(0) & ((\a~combout\(1)) # (\a~combout\(3) $ (\a~combout\(2)))))
...
-- Equation(s):
-- \inst1|Mux0~0_combout\ = (\b~combout\(3) & (\b~combout\(0) & (\b~combout\(1) $ (\b~combout\(2))))) # (!\b~combout\(3) & (!\b~combout\(1) & (\b~combout\(0) $ (\b~combout\(2)))))
...
-- Equation(s):
-- \inst1|Mux1~0_combout\ = (\b~combout\(1) & ((\b~combout\(0) & (\b~combout\(3))) # (!\b~combout\(0) & ((\b~combout\(2)))))) # (!\b~combout\(1) & (\b~combout\(2) & (\b~combout\(3) $ (\b~combout\(0)))))
...
-- Equation(s):
-- \inst1|Mux2~0_combout\ = (\b~combout\(3) & (\b~combout\(2) & ((\b~combout\(1)) # (!\b~combout\(0))))) # (!\b~combout\(3) & (\b~combout\(1) & (!\b~combout\(0) & !\b~combout\(2))))
...
-- Equation(s):
-- \inst1|Mux3~0_combout\ = (\b~combout\(0) & (\b~combout\(1) $ (((!\b~combout\(2)))))) # (!\b~combout\(0) & ((\b~combout\(1) & (\b~combout\(3) & !\b~combout\(2))) # (!\b~combout\(1) & (!\b~combout\(3) & \b~combout\(2)))))
...
-- Equation(s):
-- \inst1|Mux4~0_combout\ = (\b~combout\(1) & (!\b~combout\(3) & (\b~combout\(0)))) # (!\b~combout\(1) & ((\b~combout\(2) & (!\b~combout\(3))) # (!\b~combout\(2) & ((\b~combout\(0))))))
...
-- Equation(s):
-- \inst1|Mux5~0_combout\ = (\b~combout\(1) & (!\b~combout\(3) & ((\b~combout\(0)) # (!\b~combout\(2))))) # (!\b~combout\(1) & (\b~combout\(0) & (\b~combout\(3) $ (!\b~combout\(2)))))
...
-- Equation(s):
-- \inst1|Mux6~0_combout\ = (\b~combout\(0) & ((\b~combout\(3)) # (\b~combout\(1) $ (\b~combout\(2))))) # (!\b~combout\(0) & ((\b~combout\(1)) # (\b~combout\(3) $ (\b~combout\(2)))))
...
-- pragma translate_on
PORT MAP (
	datain => \inst|ALT_INV_Mux6~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
